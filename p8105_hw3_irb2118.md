...
although there are more males with high school equivalents than females.
...
differences between men and women are more subtle, however it appears
that females generally have higher total activity levels than men.
...
This dataframe, `citi_df`, has `r`nrow(citi_df)\` rows and 8 columns. It
shows rides taken in January and July, in 2020 and 2024. It shows the
start and endpoint, the day of the week, the duration of the ride,
whether the rider was a member or not, and what type of bike they rode
(regular vs. ebike).
...
- The peak ridership day of the week has varied by month and year, but
  ...
  to ride, except for in July 2020 (possibly impacted by COVID-19
  restrictions).
...
<img src="p8105_hw3_irb2118_files/figure-gfm/unnamed-chunk-18-1.png" width="90%" />
...
<img src="p8105_hw3_irb2118_files/figure-gfm/unnamed-chunk-19-1.png" width="90%" />
